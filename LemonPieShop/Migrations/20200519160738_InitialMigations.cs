...
namespace LemonPieShop.Migrations
{
    ...
    {
        protected override void Up(MigrationBuilder migrationBuilder) //tablo oluşturacak
        {
        ...
        protected override void Down(MigrationBuilder migrationBuilder) //geri alırken tabloları silecek
        {
